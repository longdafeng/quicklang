-- Word library migration. Restart-safe DDL; registered with the embedded runner.
...
CREATE TABLE IF NOT EXISTS ql_word (
...
-- Native seekdb ARRAY, not JSON. The engine does not allow an array default.
-- Supply '[]' explicitly when creating an empty book. Validate references in the app.
